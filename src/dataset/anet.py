	...
	def get_description(self, split):	 
		...
		if split == "train":
			...
			for vid in train.keys():
				...
				self.desp[vid] = descrps.lower().split()
		else:
...
class ActivityNetCaptionsDataset(AbstractDataset):
	def __init__(self, config):
		...
		self.feat_hdf5 = "/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/feats/sub_activitynet_v1-3.c3d.hdf5"
		...
		ann_path = config.get("annotation_path",
				"/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/captions/annotations/train.json")
	...
	def generate_labels(self, config):
		...
		if not os.path.exists(self.paths["query_labels"]):
			...
			train_ann_path = "/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/captions/annotations/train.json"
			train_anns, _, _ = self._load_annotation(train_ann_path)
			wtoi = self._build_vocab(train_anns, None)
...
def get_loader():
	conf = {
		"train_loader": {
			...
			"split": "train",
			"batch_size": 100,
			"data_dir": "/Users/yanjungao/Desktop/LGI4temporalgrounding-master",
			"annotation_path": "/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/captions/annotations/train.json",
			"video_feature_path": "/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/feats/i3d_fps30/{}.npy",
			"max_length": 25,
		...
		"test_loader": {
			...
			"data_dir": "/Users/yanjungao/Desktop/LGI4temporalgrounding-master/",
			"annotation_path":
				["/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/captions/annotations/val_1.json",
				"/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/captions/annotations/val_2.json"],
			"video_feature_path": "/Users/yanjungao/Desktop/LGI4temporalgrounding-master/data/ActivityNet/feats/i3d_fps30/{}.npy",
			"max_length": 25,
			"word_frequency_threshold": 1,
			"num_segment": 128,
